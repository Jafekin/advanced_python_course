...
|------|---------|------------|------------|---------|
| 第1讲 | 如何借助AI快速完成数据处理？ | Pandas 数据读取、清洗、转换、聚合 | Vibe Coding 提示、迭代生成、代码纠错 | 编程搭档 |
| 第2讲 | 如何把数据转化为可信的视觉表达？ | Matplotlib、Seaborn 高阶可视化 | 图表方案生成、视觉审查、结论修正 | 设计顾问 |
| 第3讲 | 如何将AI生成的原型变成可靠工程？ | 模块化、类型注解、异常处理、测试 | Spec 定义、任务分解、约束实现 | 受控开发者 |
| 第4讲 | 如何系统掌握与大模型对话的技术？ | NLP 基础、分词、采样参数、API 调用 | Prompt Engineering 全景 | Prompt 设计师 |
| 第5讲 | 如何深入模型内部并定制它？ | Transformer、预训练、BERT 微调、LoRA | AI 辅助微调代码编写 | 训练助手 |
| 第6讲 | 如何让模型基于真实文档回答？ | 大模型部署、RAG 流水线从零实现 | Spec-driven 部署规约 | 部署工程师 |
| 第7讲 | 如何让检索更准、让Agent有记忆？ | 高级检索策略、RAG 评估、记忆系统 | Prompt 调优、上下文工程 | 检索优化师 |
| 第8讲 | 如何让模型自主思考并执行行动？ | Agent 工具调用、ReAct、多Agent协作 | Agent Skills、MCP、全工具链总结 | Agent 架构师 |
